...
//#include "Mail.h"
//#include <set>
//// #define USER_MAIL "lntlynguyenthuong@gmail.com"
//std::string client_mail = "hieudapchailo@gmail.com";
//std::set<std::string> listUserMail;
//#define CREDENTIALS_PATH "credentials.json"
//void addUser(std::set<std::string>& lst) {
//	std::string user_mail;
//	std::cout << "input user_mail: ";
//	std::cin >> user_mail;
//	std::cin.clear();
//	std::cin.ignore();
//	lst.insert(user_mail);
//}
...
//
//	addUser(listUserMail);
//	for (std::string x : listUserMail) std::cout << x;
...
//			if (!listUserMail.count(messageContent[2])) continue;
